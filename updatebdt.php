        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <form action="updatebdt.php" method="POST">
            <div class="form-group">
              <label>Nama</label>
              <input type="text" class="form-control" name="nama" value="<?php echo $nama;  ?>" required="required">
            </div>
            <div class="form-group">
              <label>Tanggal_lahir</label>
              <input type="text" class="form-control" placeholder="Masukkan Tanggal Lahir" name="tanggal_lahir" value="<?php echo $tanggal_lahir;  ?>" required="required">
            </div>
            <div class="form-group">
              <label>Berat</label>
              <input type="text" class="form-control" placeholder="Masukkan Berat" name="berat" value="<?php echo $berat;  ?>" required="required">
            </div>
            <div class="form-group">
              <label>Tinggi</label>
              <input type="text" class="form-control" placeholder="Masukkan Tinggi" name="tinggi" value="<?php echo $tinggi;  ?>" required="required">
            </div>
            <div class="form-group">
              <label>Alamat</label>
              <input type="text" class="form-control" placeholder="Masukkan Alamat" name="alamat" value="<?php echo $alamat;  ?>" required="required">
            </div>
